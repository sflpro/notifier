...
import com.sflpro.notifier.api.model.common.AbstractResponseModel;
...
public class ResultResponseModel<T extends AbstractResponseModel> implements Serializable {
    ...
    public boolean checkIfErrorExists(final ErrorType errorType) {
        ...
        for (final ErrorResponseModel errorModel : errors) {
            if(errorType.equals(errorModel.getErrorType())) {
                exists = true;
                break;
            }
        }
