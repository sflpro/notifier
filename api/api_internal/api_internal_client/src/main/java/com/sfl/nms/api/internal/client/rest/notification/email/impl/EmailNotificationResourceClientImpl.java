package com.sfl.nms.api.internal.client.rest.notification.email.impl;

import com.sfl.nms.api.internal.client.rest.common.AbstractResourceClient;
import com.sfl.nms.api.internal.client.rest.notification.email.EmailNotificationResourceClient;
...
public class EmailNotificationResourceClientImpl extends AbstractResourceClient implements EmailNotificationResourceClient {
    ...
    /* Constants */
    private static final String PATH_EMAIL_CREATE = "rest/notification/email/create";
    ...
    /* Utility methods */
    private void assertCreateEmailNotificationRequest(final CreateEmailNotificationRequest request) {
        if (request == null) {
