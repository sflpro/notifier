package com.sfl.nms.api.internal.client.rest.notification.sms.impl;

import com.sfl.nms.api.internal.client.rest.common.AbstractResourceClient;
import com.sfl.nms.api.internal.client.rest.notification.sms.SmsNotificationResourceClient;
...
public class SmsNotificationResourceClientImpl extends AbstractResourceClient implements SmsNotificationResourceClient {
    ...
    /* Utility methods */
    private void assertCreateSmsNotificationRequest(final CreateSmsNotificationRequest request) {
        if (request == null) {
