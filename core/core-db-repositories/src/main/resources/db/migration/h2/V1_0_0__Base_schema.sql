...
create table if not exists notification_push_recipient (
  ...
  last_device_id bigint auto_increment,
...
create table if not exists notification_push_recipient_device (
  ...
  device_id bigint auto_increment not null constraint fk_notification_push_recipient_device_device_user  references device_user,
  recipient_id bigint auto_increment not null constraint fk_notification_push_recipient_device_notification_push_reciepeint references notification_push_recipient,
  created timestamp not null,
  removed timestamp,
  updated timestamp not null,
...
create table if not exists notification_push_subscription (
  ...
  nms_user_id bigint auto_increment not null constraint uk_notification_push_recipeint_sns_ unique,
  created timestamp not null,
  removed timestamp,
  updated timestamp not null,
...
create table if not exists notification_push_subscription_request (
  ...
  nms_user_id bigint auto_increment not null,
  user_device_id bigint auto_increment not null,
...
create table if not exists notification_usernotification_sms (
  ...
  notification_id bigint auto_increment not null constraint uk_notification_usernotification_sms_notification_id unique,
  nms_user_id bigint auto_increment not null constraint fk_notification_usernotification_sms_nms_user references nms_user,
  created timestamp not null,
  removed timestamp,
  updated timestamp not null,
