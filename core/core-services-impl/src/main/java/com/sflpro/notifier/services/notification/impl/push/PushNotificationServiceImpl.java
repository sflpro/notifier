...
public class PushNotificationServiceImpl extends AbstractNotificationServiceImpl<PushNotification> implements PushNotificationService {
    ...
    @Nonnull
    @Override
    public List<PushNotification> createNotificationsForUserActiveRecipients(@Nonnull final Long userId, @Nonnull final PushNotificationDto pushNotificationDto, @Nonnull final List<NotificationPropertyDto> pushNotificationPropertyDTOs) {
    ...
    private void createAndAddPushNotificationProperties(final PushNotification pushNotification, final List<NotificationPropertyDto> notificationPropertyDTOs) {
        notificationPropertyDTOs.forEach(propertyDTO -> {
            // Assert push notification property DTO
            assertPushNotificationPropertyDto(propertyDTO);
            ...
            notificationProperty.setNotification(pushNotification);
            pushNotification.getProperties().add(notificationProperty);
        });
    }
