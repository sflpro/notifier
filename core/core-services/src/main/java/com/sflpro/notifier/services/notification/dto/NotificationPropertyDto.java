 ...
 * Time: 11:32 AM
 */
public class NotificationPropertyDto extends AbstractDomainEntityModelDto<NotificationProperty> {
    ...
    @Override
    public void updateDomainEntityProperties(final NotificationProperty pushNotificationProperty) {
