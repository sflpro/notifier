...
class MsgAmConfiguration {
    ...
    private static final String MSGAM_PROVIDER_REGISTRY_NAME = "msgam";
    ...
    @ConditionalOnMissingBean(MsgAmMessageIdProvider.class)
    MsgAmMessageIdProvider msgAmMessageIdProvider() {
    ...
    TemplatedSmsSender msgAmTemplatedSmsSender(final MsgAmApiCommunicator msgAmApiCommunicator, MsgAmMessageIdProvider msgAmMessageIdProvider, final SmsTemplateContentResolver smsTemplateContentResolver) {
