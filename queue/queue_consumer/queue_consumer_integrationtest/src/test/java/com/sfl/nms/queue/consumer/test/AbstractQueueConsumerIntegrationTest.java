package com.sfl.nms.queue.consumer.test;
 ...
 */
@Ignore
@ContextConfiguration(value = {"classpath:applicationContext-queue-consumer-services-integrationtest.xml", "classpath:applicationContext-services-integrationtest.xml"})
