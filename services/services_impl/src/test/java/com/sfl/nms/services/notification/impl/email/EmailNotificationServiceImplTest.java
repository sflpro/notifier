...
public class EmailNotificationServiceImplTest extends AbstractNotificationServiceImplTest<EmailNotification> {
    ...
    public void testCreateEmailNotificationWithInvalidArguments() {
        ...
        try {
            emailNotificationService.createEmailNotification(new EmailNotificationDto(emailNotificationDto.getRecipientEmail(), emailNotificationDto.getSenderEmail(), emailNotificationDto.getProviderType(), null, emailNotificationDto.getSubject(), emailNotificationDto.getClientIpAddress()));
            fail("Exception should be thrown");
        } catch (final IllegalArgumentException ex) {
            // Expected
        }
