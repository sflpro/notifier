...
import com.sfl.nms.services.notification.exception.push.PushNotificationRecipientNotFoundForLookupParametersException;
...
import com.sfl.nms.services.util.mutable.MutableHolder;
import com.sfl.nms.persistence.repositories.notification.push.AbstractPushNotificationRecipientRepository;
import com.sfl.nms.persistence.repositories.notification.push.PushNotificationRecipientDeviceRepository;
import com.sfl.nms.persistence.repositories.notification.push.PushNotificationRecipientRepository;
...
import com.sfl.nms.services.notification.exception.push.PushNotificationRecipientInvalidDeviceUserException;
import com.sfl.nms.services.notification.exception.push.PushNotificationRecipientNotFoundForIdException;
...
public abstract class AbstractPushNotificationRecipientServiceImplTest<T extends PushNotificationRecipient> extends AbstractServicesUnitTest {
    ...
    public void testUpdatePushNotificationRecipientUserDeviceWhenDeviceIsNotAssociatedYet() {
        ...
        expect(pushNotificationRecipientDeviceRepository.save(isA(PushNotificationRecipientDevice.class))).andAnswer(() -> {
            ...
            assertEquals(userDevice, recipientDevice.getDevice());
        ...
        assertEquals(userDevice, result.getLastDevice());
