...
import com.sfl.nms.persistence.repositories.notification.push.PushNotificationSubscriptionRequestRepository;
...
import com.sfl.nms.services.notification.exception.push.PushNotificationSubscriptionRequestInvalidRecipientUserException;
import com.sfl.nms.services.notification.exception.push.PushNotificationSubscriptionRequestNotFoundForIdException;
import com.sfl.nms.services.notification.exception.push.PushNotificationSubscriptionRequestNotFoundForUuIdException;
...
public class PushNotificationSubscriptionRequestServiceImplTest extends AbstractServicesUnitTest {
    ...
    public void testCreatePushNotificationSubscriptionRequest() {
        ...
        assertEquals(userDevice, result.getUserMobileDevice());
        // Verify
        verifyAll();
    }
    ...
    private void assertPushNotificationSubscriptionRequestNotFoundForIdException(final PushNotificationSubscriptionRequestNotFoundForIdException ex, final Long id) {
        ...
        assertEquals(ex.getEntityClass(), PushNotificationSubscriptionRequest.class);
    }
